...
def req_check_deps():
    try:
        ...
        if discord.version_info.major < 1:
            log.critical("This version of MusicBot requires a newer version of pycord. Your version is {0}. Try running update.py.".format(discord.__version__))
            bugger_off()
    except ImportError:
    ...
    while tryagain:
        ...
        try:
            ...
            if hasattr(e, "__module__") and e.__module__ == "musicbot.exceptions":
                ...
                log.exception("Error Starting Bot Bootstrap Process. ")
