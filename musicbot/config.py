...
class Config:
    ...
    def __init__(self, config_file):
        ...
        self.bgmexclusion = config.get("Files", "BgmExclusionFile", fallback=ConfigDefaults.bgm_exclusion_file)
        self.niconico_session = config.get("Credentials", "niconico_session", fallback=ConfigDefaults.niconico_session)
...
class ConfigDefaults:
    ...
    bgmmode = False
    bgmlength = 60
    bgm_exclusion_file = "config/bgmexclusion_title.txt"
    niconico_session = None
