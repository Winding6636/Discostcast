...
class Config:
    ...
    def __init__(self, config_file: pathlib.Path) -> None:
        ...
        self.bgmmode: bool = self.register.init_option(
            section="MusicBot",
            option="BgmWakuMode",
            dest="bgm_waku_mode",
            default=ConfigDefaults.bgmmode,
            getter="getboolean",
            comment="BGM mode on/off. Cuts off playback at the specified time. (Cut processing)",
        )
        self.bgmlength: int = self.register.init_option(
            section="MusicBot",
            option="BgmLength",
            dest="bgm-song-length",
            default=ConfigDefaults.bgmlength,
            getter="getint",
            comment=(
                "Song playback time in BGM mode (Seconds)\n"
            ),
        )
